	...
	<div class="book-testdrive">
		...
		<div class="test-drive">
			<div class="test-drive-form">
				<div class="test-drive-form-header">Book a Test Drive</div>
					...
					<validation-observer v-slot="{ invalid, handleSubmit }">
						<form @submit.prevent="handleSubmit(submitTestdrive)">
							...
							<div class="form-group">
								...
								>
									<textarea
										...
										id="comments"
										v-model="comments"
										placeholder="Enter comments or questions here"
									></textarea>
									<div class="text-danger push-right">{{ errors[0] }}</div>
								</validation-provider>
							</div>
							...
							<b-modal
								v-model="show"
								id="book-testdrive"
								title="Confirm your testdrive booking"
							>
								<p class="my-4">
									Are your sure you want to book this car for a testdrive?
								</p>
