				...
				<div class="flex-items">
					<div v-for="(car, idx) in this.getCars" :key="idx" class="car-item">
						...
						<div class="car-details">
							...
							<button
								type="submit"
								@click.prevent="routeUpdate(car)"
								class="btn btn-yellow right-margin"
							>
								Update
							</button>
							<b-button @click="deleteButton(car)" class="btn btn-red"
								>Delete</b-button
							>
...
export default {
	...
	methods: {
		...
		async deleteCar() {
			await axios
				.delete(`http://localhost:5000/deletecar/${this.car.model_id}`)
				.then(() => {
