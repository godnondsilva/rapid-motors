                        ...
                        <form @submit.prevent="handleSubmit(submitCategory)">
                            <div class="form-group">
                                <label for="Category">Category</label>
                                    ...
                                    <input type="text" id="state" v-model="name" placeholder="Enter the category name">
                            ...
                            <div class="form-group">
                                ...
                                <validation-provider rules="required|min:3|max:255" v-slot="{ errors }">
                                    <textarea type="text" id="description" v-model="description" placeholder="Enter the category description here"></textarea>
                                    <div class="text-danger push-right">{{ errors[0] }}</div>
                                </validation-provider>
                            </div>
                            <b-button @click="show=true" :disabled="invalid" class="btn btn-yellow push-right">Add Category</b-button>

                            <b-modal v-model="show" id="add-category" title="Confirm category addition">
...
export default {
    ...
    methods: {
        ...
        async submitCategory() {
            ...
            await axios.post('http://localhost:5000/addcategory', categoryData, {
                headers: {
