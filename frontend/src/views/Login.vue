                ...
                <validation-observer v-slot="{ invalid, handleSubmit }">
                    <form @submit.prevent="handleSubmit(login)">
                        ...
                        <div class="bottom-question">
                            <router-link class="router-link" to="/forgotpassword">Forgot your password? Click here</router-link>
                        </div>
                        <div class="bottom-question">
                            <router-link class="router-link" to="/adminlogin">Are you an admin? Please login here</router-link>
                        </div>
