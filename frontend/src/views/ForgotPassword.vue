				...
				<validation-observer v-slot="{ invalid, handleSubmit }">
					<form @submit.prevent="handleSubmit(forgotPassword)">
						<div class="form-group">
							<p>
								If you have forgotten your password, we can send you your
								password to your registered email address.
							</p>
							<p>
								Please enter your email address below so that we can send you
								your password.
							</p>
						</div>
						<div class="form-group">
						...
						<b-modal
							...
							id="forgot-password"
							type="submit"
							:title="forgotPasswordFormHeader"
						>
			...
			await axios
				...
				.then((response) => {
					...
					// error case
						...
						this.forgotPasswordFormText =
							'There exists no account for the given email.';
					} else {
						this.forgotPasswordFormHeader = 'Error!';
						this.forgotPasswordFormText =
